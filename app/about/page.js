          ...
          <div className={styles.heroInner}>
            ...
            <div className={`${styles.trustBar} ${aboutStyles.heroRise} ${aboutStyles.heroTrust}`}>
              {trust.map(([number, label], index) => (
                <div
                  className={`${styles.trustItem} ${aboutStyles.trustItemRise}`}
                  style={{ '--item-delay': `${1.05 + index * 0.14}s` }}
                  key={label}
                >
          ...
          <div className={styles.sectionInner}>
            <div className={styles.storyResolve}>
              ...
              <Reveal delay={150}>
                ...
                <blockquote className={`${styles.quotePanel} ${aboutStyles.quoteHover} ${aboutStyles.compactQuote}`}>
