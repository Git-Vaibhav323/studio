        ...
        <div className={styles.brandCol}>
          ...
          <div className={styles.social}>
            ...
            <div className={styles.socialIcons}>
              {[
                { label:'Instagram', href:'https://www.instagram.com/thespatialedit.in/', svg:<svg viewBox="0 0 24 24" fill="var(--cream)" strokeWidth="1.5" stroke="var(--cream)"><rect x="2" y="2" width="20" height="20" rx="5" ry="5" stroke="none"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" fill="#111"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" stroke="#111" strokeWidth="2"/></svg> },
