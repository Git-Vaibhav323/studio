...
// Use globalThis to survive HMR reloads in dev without creating new instances.
let _browserClient = (typeof globalThis !== 'undefined' && globalThis.__spatialSupabaseClient) || null;

export const createSupabaseClient = () => {
  if (!supabaseUrl || !supabaseAnonKey) return null;
  if (_browserClient) return _browserClient;
  _browserClient = createBrowserClient(supabaseUrl, supabaseAnonKey);
  if (typeof globalThis !== 'undefined') globalThis.__spatialSupabaseClient = _browserClient;
